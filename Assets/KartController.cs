...
public class KartController : MonoBehaviour
{
    ...
    public float normalAlignmentSpeed = 140f;
    ...
    void Update()
    {
        ...
        //Follow Collider
        transform.position = sphere.transform.position - new Vector3(0, 0f, 0);
    ...
    private void FixedUpdate()
    {
        ...
        sphere.AddForce(gravity, ForceMode.Acceleration);

        //Steering
        kartNormal.localRotation *= Quaternion.AngleAxis(currentRotate * Time.fixedDeltaTime * 5f, Vector3.up);

        RaycastHit hitNear;

        Vector3 normalizedGravity = gravity.normalized;
        Physics.Raycast(kartModel.position + (-normalizedGravity * .3f), normalizedGravity, out hitNear, 20.0f, layerMask);

        //Normal Rotation
        transform.rotation = Quaternion.RotateTowards(transform.rotation, Quaternion.FromToRotation(transform.up, hitNear.normal) * transform.rotation, this.normalAlignmentSpeed * Time.fixedDeltaTime);

        // Debug.DrawRay(kartNormal.position, kartNormal.up, Color.green, 0);
        // Debug.DrawRay(kartNormal.position, kartNormal.forward, Color.blue, 0);

        // Debug.DrawRay(transform.position, transform.up, Color.red, 0);
        // Debug.DrawRay(transform.position, transform.forward, Color.red, 0);
    }
